...
<div class="text-center" style="padding-bottom:200px;padding-top:200px;background-image:url(background.jpg);  background-size:cover">
    <p style="font-weight:bold;font-size:75px;color:navy">404 ERROR</p>
    <p style="font-size:20px;">OOPS! THIS PAGE CAN'T BE FOUND</p>
    <p style="font-size:20px;color:red;">Sorry, but the page you are looking for does not exist or has been removed</p>
</div>
