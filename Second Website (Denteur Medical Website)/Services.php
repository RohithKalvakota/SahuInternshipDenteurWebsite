...
<nav>
        ...
        <div class="forimage">
          ...
          <h3 style="font-weight:bold;color:white;font-size:35px;padding-left:100px;">Denteur<br>Services<h3>
          <p style="color:white;font-size:20px;padding-left:100px;padding-bottom:75px;"> Home > Services</p>
          </div>
        </div>
<br>
<br>
...
<div class="row6">
  <div class="column6">
    <div class="card6">
      ...
      <a href = "OD.php" style="color:blue;font-size:20px;font-weight:bold;">Read More</a>
    </div>
  </div>
  ...
  <div class="column6">
    <div class="card6">
      ...
      <h3 style="font-weight:bold;padding-top:33px;">Endodontic</h3>
      <p style="font-size:18px;padding-top:20px;">Measures of poor oral health in<br>the study includied painful.</p>
      <a href = "Endotonic.php" style="color:blue;font-size:20px;font-weight:bold;">Read More</a>
    </div>
  </div>
  ...
  <div class="column6">
    <div class="card6">
      ...
      <p style="font-size:18px;padding-top:20px;">Measures of poor oral health in<br>the study includied painful.</p>
      <a href = "FD.php" style="color:blue;font-size:20px;font-weight:bold;">Read More</a>
    </div>
  </div>
...
<div class="row6">
  <div class="column6">
    <div class="card6">
      <a href=""><img src="Grid1.jpg"></a>
      <h3 style="font-weight:bold;padding-top:35px;">Prosthodontics</h3>
      <p style="font-size:18px;padding-top:20px;">Measures of poor oral health in<br>the study includied painful.</p>
      <a href = "Prosthodontics.php" style="color:blue;font-size:20px;font-weight:bold;">Read More</a>
    </div>
  </div>
  ...
  <div class="column6">
    <div class="card6">
      <a href=""><img src="Grid2.jpg"></a>
      <h3 style="font-weight:bold;padding-top:15px;">Surgery Department</h3>
      <p style="font-size:18px;padding-top:14px;">Measures of poor oral health in<br>the study includied painful.</p>
      <a href = "SD.php" style="color:blue;font-size:20px;font-weight:bold;">Read More</a>
    </div>
  </div>
