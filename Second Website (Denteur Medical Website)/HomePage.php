...
<div class="row1">
  ...
  <form action="insert2.php" method="post" autocomplete="off">
        <input type="text" name="Name" value="Official Name" onfocus="this.value=''" style="font-size:20px;border-radius:30px;text-align:center;" required/>
      <br>
        <input type="text" name="phonenum" onfocus="this.value=''" value="Phone Number" style="font-size:20px;border-radius:30px;text-align:center;" required/>
      <br>
        <input type="email" name="email" onfocus="this.value=''" value="Email Address" style="font-size:20px;border-radius:30px;text-align:center;" required />
      <br>
      <center>
      <input type="submit" value="Submit" style="font-weight:bold;background-color:yellow;color:black;font-size:15px;">
    </center>
