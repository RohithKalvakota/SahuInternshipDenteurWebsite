...
<nav>
        ...
        <div class="forimage">
           ...
           <h3 style="font-weight:bold;color:white;font-size:35px;padding-left:100px;">Department<br>Surgery<h3>
           <p style="color:white;font-size:20px;padding-left:100px;padding-bottom:75px;"> Departments > Surgery Department</p>
           </div>
         </div>
 ...
 <div class="row2">
   <div class="column2">
     <img style="padding-left:155px;padding-top:25px;" src="SD1.jfif" width="100%">
     <h2 style="padding-left:155px;font-weight:bold;">Surgery Department</h2>
