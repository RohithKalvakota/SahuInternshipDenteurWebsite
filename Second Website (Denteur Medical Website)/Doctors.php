...
<nav>
        ...
        <div class="forimage">
           ...
           <h3 style="font-weight:bold;color:white;font-size:35px;padding-left:100px;">Denteur<br>Doctors<h3>
           <p style="color:white;font-size:20px;padding-left:100px;padding-bottom:75px;"> Pages > Doctors</p>
           </div>
         </div>
 ...
 <div style="position: relative;margin-top:75px;" class="card200">
   <img src="doctor4.jfif" alt="Avatar" style="width:100%">
   <div class="container200">
     <div class="text-center">
     <p style="font-size:30px;font-weight:bold;padding-top:20px;"><b>Michael Lee</b></>
     <p style="color:navy;font-size:20px;font-weight:bold;">Periodontist</p>
     <p>There are many variations of passages of Lorem Ipsum available but the majority.</p>
     <a href="#" class="fa fa-facebook"></a>
     <a href="#" class="fa fa-twitter"></a>
     <a href="#" class="fa fa-linkedin"></a>
 ...
 <div style="position: relative;margin-top:75px;" class="card200">
   <img src="doctor5.jfif" alt="Avatar" style="width:100%">
   <div class="container200">
     <div class="text-center">
     <p style="font-size:30px;font-weight:bold;padding-top:20px;"><b>Jackie Graham</b></>
     <p style="color:navy;font-size:20px;font-weight:bold;">Periodontist</p>
     <p>There are many variations of passages of Lorem Ipsum available but the majority.</p>
     <a href="#" class="fa fa-facebook"></a>
     <a href="#" class="fa fa-twitter"></a>
 ...
 <div style="position: relative;margin-top:75px;" class="card200">
   <img src="doctor6.jfif" alt="Avatar" style="width:100%">
   <div class="container200">
     <div class="text-center">
     <p style="font-size:30px;font-weight:bold;padding-top:20px;"><b>Ronald Cimino</b></>
     <p style="color:navy;font-size:20px;font-weight:bold;">Orthopedic</p>
     <p>There are many variations of passages of Lorem Ipsum available but the majority.</p>
     <a href="#" class="fa fa-facebook"></a>
     <a href="#" class="fa fa-twitter"></a>
