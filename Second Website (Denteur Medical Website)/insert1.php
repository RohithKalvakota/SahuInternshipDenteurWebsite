...
<div class="row2">
  ...
  $sql = "INSERT INTO contactus VALUES ('$name','$email',
      '$num','$Message')";

  if(mysqli_query($conn, $sql)){
      echo '<div style="font-size:1.2em;color:blue;font-weight:bold;font-style:italic;">Thanks for leaving a feedback, have a great day.<br>';
...
<form action="ContactUs.php">
    <input type="submit" style="color:white;font-size:20px;background-color:black;" value="To send us another message. Click here." />
</form>
