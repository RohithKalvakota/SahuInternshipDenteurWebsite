...
<div class="forimage">
   ...
   <h3 style="font-weight:bold;color:white;font-size:35px;padding-left:100px;">FAQ<h3>
   <p style="color:white;font-size:20px;padding-left:100px;padding-bottom:75px;"> Pages > FAQ</p>
   </div>
 </div>
...
<br>
    ...
    <h1 style="padding-left:110px;font-weight:bold;">Frequently Asked Questions</h1>
    ...
    <button class="collapsible">How long is my Warranty?</button>
    <div class="content">
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
    </div>
    <button class="collapsible">What is a lifetime gurantee?</button>
    <div class="content">
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
    </div>
