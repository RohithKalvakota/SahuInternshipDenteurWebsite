...
<head>
	...
	<div class="navbar">
		<a href="New.php"><img src="Logo.jpg" height="0px"></a>
		<a href="New.php" style="padding-left:5px;padding-right:5px;margin-left:50px;">Home</a>
...
<center>
	<h2 style="color:red;font-style:italic;font-weight:bold">Submit Your Pictures and they may get featured in the distinct future in of our blogs.Please Make Sure they follow our policies.</h2>
	<br>
	<center>
	<form action="Policy.php">
	<input type="submit" value="Click here to have a look at the policies." style="font-weight:bold;background-color:orange;color:blue;font-size:20px;">
	</form>
	</center>
	<br>
	<hr style="width:75%;border:2px solid lightblue;">
	<br>
	<br>
	<br>
	<br>
...
<form method="POST" action="upload.php" enctype="multipart/form-data">
	<input style="font-size:25px;color:blue;" type="file" name="uploadfile" value=""/>
	<br>
	<input style="font-size:25px;color:blue;" type="submit" name="upload" value="Submit">
