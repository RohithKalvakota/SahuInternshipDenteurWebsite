...
<div class="container p-5">
  ...
  <div class="container1">
        <div class="image1">
          <p><img src = "blog11.jfif" width = "700" style = "margin-left:20px;border-radius:3%"></p>
        </div>
        <div class="text1">
