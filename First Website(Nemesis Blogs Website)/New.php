...
<div class="container p-5">
  <div class="container1">
        <div class="image1">
          <a href="HomeBlog.php"><img src = "Beach.jfif" width = "700" style = "border-radius:3%"></a>
        </div>
        <div class="text1">
          <a style="color:black;" href="HomeBlog.php"><h1 style = "font-size:35px;font-family: 'Trebuchet MS', sans-serif;font-weight:bold;">Lorem ipsum <br> dolor sit amet, <br> consectetur <br> adipiscing elit.</h1></a>
          <h6 style = "font-size:14px;color:gray;padding-top:20px;padding-bottom:20px;">FBTEMPLATES / March 25, 2021</h6>
          <a href="HomeBlog.php"><button class="button1">Keep reading ...</button></a>
  </div>
  </div>
    <div class="row p-5">
        <div class="col-lg-4 pb-5">
        <div class="background1 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="blog1.php">
        ...
        <div class="col-lg-4 pb-5">
        <div class="background2 card-radius text-light">
            <div class="text-desc-even">
              <a style="color:white;font-weight:bold;" href="blog2.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background3 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="blog3.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background4 card-radius text-light">
            <div class="text-desc-even">
            <a style="color:white;font-weight:bold;" href="blog4.php">
                Lorem ipsum dolor sit amet,consectetur adipiscing elit
            </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background5 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="blog5.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background6 card-radius text-light">
            <div class="text-desc-even">
              <a style="color:white;font-weight:bold;" href="blog6.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background7 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="blog7.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background8 card-radius text-light">
            <div class="text-desc-even">
            <a style="color:white;font-weight:bold;" href="blog8.php">
                Lorem ipsum dolor sit amet,consectetur adipiscing elit
            </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background9 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="blog9.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <a href="MorePosts.php"><button type="button" class="btn btn-danger btn-circle btn-xl" style="margin-left:500px;display:block"><b>More Posts<br><span class="glyphicon glyphicon-menu-down"></span></b></button></a>
    </div>
</div>
