...
<div class="container p-5">
    ...
    <div class="row p-5">
        ...
        <div class="background10 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="Blog10.php">
        ...
        <div class="col-lg-4 pb-5">
        <div class="background11 card-radius text-light">
            <div class="text-desc-even">
              <a style="color:white;font-weight:bold;" href="Blog11.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background12 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="Blog12.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background13 card-radius text-light">
            <div class="text-desc-even">
              <a style="color:white;font-weight:bold;" href="Blog13.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background14 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="Blog14.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
