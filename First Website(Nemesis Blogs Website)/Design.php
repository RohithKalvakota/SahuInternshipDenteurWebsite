...
<div class="container90">
  <img src="Design.jfif" width="75%" height="650px" style="border-radius:30px;">  <br>
  <div style="color:white;font-size:100px;font-weight:bold;font-family: 'Trebuchet MS', sans-serif;font-size:85px;" class="centered">Design</div>
</div>
<div class="container p-5">

    <div class="row p-5">
        <div class="col-lg-4 pb-5">
        <div class="background20 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="Design1.php">
        ...
        <div class="col-lg-4 pb-5">
        <div class="background21 card-radius text-light">
            <div class="text-desc-even">
              <a style="color:white;font-weight:bold;" href="Design2.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background22 card-radius text-light">
            <div class="text-desc-odd">
              <a style="color:white;font-weight:bold;" href="Design3.php">
                  Lorem ipsum dolor sit amet,consectetur adipiscing elit
              </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
        ...
        <div class="col-lg-4 pb-5">
        <div class="background23 card-radius text-light">
            <div class="text-desc-even">
            <a style="color:white;font-weight:bold;" href="Design4.php">
                Lorem ipsum dolor sit amet,consectetur adipiscing elit
            </a>
            <p class="pt-2" style="font-weight:bold;">FB TEMPLATES / March 28,2017</p>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
