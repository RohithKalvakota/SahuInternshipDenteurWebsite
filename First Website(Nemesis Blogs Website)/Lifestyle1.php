...
<div class="container p-5">
  ...
  <div class="container1">
        <div class="image1">
          <p><img src = "Lifestyle1.jfif" width = "700" style = "margin-left:20px;border-radius:3%"></p>
        </div>
        <div class="text1">
...
<a class="fbt-newer-link text-white" href="Lifestyle3.php" id="Blog1_blog-pager-newer-link" rel="previous"><strong style="font-size:30px;" class="lead text-left pl-3"><i style="font-size:30px;" class="fa fa-angle-left"></i> Previous</strong> <div style="font-size:30px;" class="h2 text-white fbt-np-title mt-2 pl-3">Suspendisse posuere mi lacus, leo gravida eu.</div></a>
</div>
<div class="next col-lg-6 bg-warning px-5 py-5 text-right">
<a class="fbt-older-link text-white" href="Lifestyle2.php" id="Blog1_blog-pager-older-link" rel="next"><strong style="font-size:30px;" class="lead text-right pr-3">Next <i style="font-size:30px;"class="fa fa-angle-right"></i></strong> <div style="font-size:30px;" class="h2 text-white text-right fbt-np-title mt-2 pr-3">Vestibulum maximus ipsum lacus, tempus suscipit augue.</div></a>
</div>
</div>
</div>
</div>
