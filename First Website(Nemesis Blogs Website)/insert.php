...
$sql = "INSERT INTO blogform  VALUES ('$name','$email','$msg')";

if(mysqli_query($conn, $sql)){
    echo '<div style="font-size:1.5em;color:gray;font-weight:bold;">Your information has been stored and we will surely read your message.';
...
<form action="ContactUs.php">
    <input type="submit" style="color:blue;font-size:20px;background-color:orange;" value="To send us another message. Click here." />
</form>
</center>
