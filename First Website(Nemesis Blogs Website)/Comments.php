...
<div class="container p-5">
  ...
  <div class="container1">
        <div class="image1">
          <p><img src = "Beach.jfif" width = "700" style = "margin-left:20px;border-radius:3%"></p>
        </div>
        <div class="text1">
...
<br>
<div style="padding-right:190px;padding-left:190px;font-family: 'Trebuchet MS', sans-serif;font-size:20px;font-style:oblique;border-radius:" class="container">
  <div style="border-radius:15px;padding-right:40px;padding-left:50px;padding-top:50px;padding-bottom:50px;" class="card bg-dark text-white">
    <div class="card-body">" Donec dolor elit, pellentesque a massa pellentesque, euismod sagittis ipsum. Nullam a diam ac turpis iaculis vulputate. Nunc tellus libero, tempus id luctus eget, fermentum et quam. Aliquam erat volutpat. Donec sit amet nunc vitae justo dapibus dignissim. Vivamus sagittis dignissim massa, auctor aliquam nibh aliquam ut. "
</div>
  </div>
  <br>
...
<div class="container my-4">
    ...
    <br>
    <div class="text-center">
      <p style="font-size:24px;color:red">Post your comments here...</p>
    </div>
    <div class="text-left" style="font-size:20px;font-style:italic;color:blue">
      <?php


      $conn = mysqli_connect("localhost", "root", "", "formblogs");
      ...
      $sql = "INSERT INTO comments  VALUES ('$name','$cmt')";
    ...
    <center>
    <form action="HomeBlog.php">
        <input type="submit" style="color:red;font-size:20px;background-color:yellow;" value="To write another comment. Click here." />
    </form>
    </center>
    </div>
    <br>
...
<f<footer class="page-footer font-small stylish-color-dark pt-4">
  <div class="down">
